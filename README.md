...
<table>
    ...
    <tbody>
        <tr height=160>
            <td><a href="archive/README.md#readme"><img width=140 src="archive.gif" alt="Old browser logo"></a></td>
        </tr>
    </tbody>
</table>
...
* Download the [`zip` archive](https://github.com/alrra/browser-logos/archive/37.1.10.zip).
* Install via:
    * [`npm`](https://www.npmjs.com/): `npm install alrra/browser-logos#37.1.10`
    * [`Yarn`](https://yarnpkg.com/): `yarn add browser-logos#37.1.10`
