...
#### 2) Get all logos:
   ...
   * Use [`cdnjs`](https://cdnjs.com/libraries/browser-logos).
   * Download the [`zip` archive](https://github.com/alrra/browser-logos/archive/39.3.0.zip).
   * Install via:
      * [`npm`](https://www.npmjs.com/): `npm install alrra/browser-logos#39.3.0`
      * [`Yarn`](https://yarnpkg.com/): `yarn add browser-logos#39.3.0`
