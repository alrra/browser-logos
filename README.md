...
* Install using:
  ...
  * [`npm`][npm]: `npm install alrra/browser-logos#62.0.10`
  * [`Yarn`][yarn]: `yarn add browser-logos#62.0.10`
...
[archive]: https://github.com/alrra/browser-logos/archive/62.0.10.zip
